...
DATABASES = {
    'default': {
        ...
        'NAME': 'scraperdb',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '*i%_9z35jk0q^7_qu0&amp;vlro%62ukv&amp;i7&amp;7-nd#(kvf5=531y_i'
...
ROOT_URLCONF = 'auto_class_scheduler.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'auto_class_scheduler.wsgi.application'
